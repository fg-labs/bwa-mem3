<!-- FG-MAIN-BANNER:start -->
> **Fulcrum Genomics fork.** The `fg-main` branch carries platform support and
> fixes on top of upstream [`bwa-mem2/bwa-mem2`](https://github.com/bwa-mem2/bwa-mem2).
> See [FG-MAIN.md](FG-MAIN.md) for the list and our update policy.
<!-- FG-MAIN-BANNER:end -->

[![CI](https://github.com/fg-labs/bwa-mem2/actions/workflows/ci.yml/badge.svg?branch=fg-main)](https://github.com/fg-labs/bwa-mem2/actions/workflows/ci.yml)
[![codecov](https://codecov.io/gh/fg-labs/bwa-mem2/branch/fg-main/graph/badge.svg)](https://codecov.io/gh/fg-labs/bwa-mem2)
