/**
 * Fulcrum Genomics — bwa-mem3 sidebar branding, breadcrumbs, footer injection.
...
(function () {
    ...
    var SIDEBAR_VERSION = 'bwa-mem3-2';
    try {
    ...
    var FOOTER_HTML =
        ...
        LOGO_SVG +
        '</a>' +
        '<p>Visit us at <a href="https://www.fulcrumgenomics.com" target="_blank" rel="noopener">Fulcrum Genomics</a> to learn more about how we power short-read alignment with bwa-mem3 and beyond.</p>' +
        ...
        '<a href="https://github.com/fg-labs/bwa-mem3" target="_blank" rel="noopener">GitHub</a>' +
    ...
    var BWA_MEM3_SECTIONS = [
        'getting-started', 'user-guide', 'performance', 'best-practices',
        'cli', 'methylation', 'whats-different', 'developer-guide',
    ...
    var docsRoot = (function () {
        ...
        if (segs.length >= 2) {
            ...
            if (BWA_MEM3_SECTIONS.indexOf(parent) !== -1) {
                return '../';
            }
        }
        return '';
    ...
    function injectBrand() {
        ...
        header.innerHTML =
            ...
            '<span style="color:#26a8e0">bwa-mem</span>' +
            '<span style="color:#38b44a">3</span>' +
            '</span>' +
            '<span class="fg-brand-tagline">Accelerated short-read alignment</span>' +
    ...
    var SECTION_MAP = {
        ...
        'cli':               'CLI Reference',
        'methylation':       'Methylation Reference',
        'whats-different':   "What's Different from bwa-mem2",
    ...
    function injectBreadcrumb() {
        ...
        var sectionLabel = SECTION_MAP[dir];
    ...
    function colorMenuTitle() {
        ...
        // "bwa-mem3" → "bwa-mem" cyan + "3" green
        if (text === 'bwa-mem3' || text.indexOf('bwa-mem3') === 0) {
            title.innerHTML =
                '<span style="color:#26a8e0">bwa-mem</span>' +
                '<span style="color:#38b44a">3</span>' +
