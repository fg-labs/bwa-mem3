...
|------------------------------|-------------------------------------------------------------|-----------------------------------------------------|
| `phix_parity.sh`             | bwa vs bwa-mem2 SAM parity on 500 PE phiX174 reads          | "Compare bwa and bwa-mem2 output"                   |
| `chr22_parity.sh`            | bwa vs bwa-mem2 SAM parity on 50k PE chr22 reads            | "Compare chr22 bwa vs bwa-mem2 (parity)"            |
